...
define view entity Z01_Demo05
  as select from /dmo/flight

{
  key carrier_id                                          as CarrierId,
      count(*)                                            as NumberOfFlights, //Gesamtanzahl aller Flüge (aggregieren => verdichten)
      count(distinct plane_type_id)                       as NumberOfDifferntPlaneTypeIds,
