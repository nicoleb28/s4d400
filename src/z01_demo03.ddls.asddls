...
@EndUserText.label: 'Demo 3: Arithmetic Operations, Cases and Built-In Function'
@Metadata.ignorePropagatedAnnotations: true
define view entity Z01_Demo03
...

{
  ...
  key c.connection_id                           as ConnectionId,
      ...
      * cast('1.1' as abap.dec(4,1))            as NewPrice2,
